...
public:
  ...
  */
  enum ColorInterpolation { ciRGB  ///< Color channels red, green and yellow are linearly interpolated
  ...
  */
  enum GradientPreset { gpGrayscale  ///< Continuous lightness from black to white (suited for non-biased data representation)
                        ...
                        ,gpCandy     ///< yellow over pink to white
                        ,gpGeography ///< Colors suitable to represent different elevations on geographical maps
                        ,gpIon       ///< Half hue spectrum from black over purple to yellow and finally green (creates banding illusion but allows more precise magnitude estimates)
                        ,gpThermal   ///< Colors suitable for thermal imaging, ranging from dark yellow over purple to orange, yellow and white
                        ,gpPolar     ///< Colors suitable to emphasize polarity around the center, with yellow for negative, black in the middle and red for positive values
